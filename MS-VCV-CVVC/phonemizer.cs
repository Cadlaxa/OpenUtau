...
namespace OpenUtau.Plugin.Builtin {
    [Phonemizer("Malay VCV & CVVC phonemizer", "MS VCV & CVVC", "Cadlaxa", language: "MS")]
    public class MSVCV_CVVCPhonemizer : SyllableBasedPhonemizer {

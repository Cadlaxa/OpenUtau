...
namespace OpenUtau.Plugins {
    public class CymCVVCTest : PhonemizerTestBase {
        public CymCVVCTest(ITestOutputHelper output) : base(output) { }

        protected override Phonemizer CreatePhonemizer() {
            return new CVVCymraegPhonemizer();
        }

        [Theory]
        [InlineData("CVVCymraeg",
        ...
        public void ColorTest() {
            RunPhonemizeTest("CVVCymraeg", new NoteParams[] {
                new NoteParams {
                    lyric = "hi",
                    hint = "",
                    tone = "C4",

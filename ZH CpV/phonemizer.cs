...
namespace OpenUtau.Plugin.Builtin {
    [Phonemizer("Chinese C+V Phonemizer", "ZH C+V", "Cadlaxa", language: "ZH")]
    // Custom C+V Phonemizer for OU
    public class ChineseCpVPhonemizer : SyllableBasedPhonemizer {
        protected override string YamlFileName => "zh-cPv.yaml";
        protected override byte[] YamlTemplate => ZH_CpV.Data.Resources.template;
        protected override string YamlVersion => "1.3.1";
        public ChineseCpVPhonemizer() {
            this.vowels = new string[] {
                // Single Vowels
                "a", "o", "e", "i", "u", "v",
                
                // Compound Vowels (Diphthongs & Triphthongs)
                "ai", "ei", "ao", "ou", 
                "ia", "ie", "iao", "iu", 
                "ua", "uo", "uai", "ui", 
                "ve", "er",
                
                // Front Nasal Vowels (Ending in -n)
                "an", "en", "in", "un", "vn", 
                "ian", "uan", "van",
                
                // Back Nasal Vowels (Ending in -ng)
                "ang", "eng", "ing", "ong", 
                "iang", "iong", "uang", "ueng"
            };
        ...
        private readonly Dictionary<string, string> missingVphonemes = "ax=ah,aa=ah,ae=ah,iy=ih,uh=uw,ix=ih,ux=uh,oh=ao,eu=uh,oe=ax,uy=uw,yw=uw,yx=iy,wx=uw,ea=eh,ia=iy,oa=ao,ua=uw,R=-,mm=m,ll=l".Split(',')
